        ...
        <div id="bot">
            <div class="container">
                <div class="row">
                    ...
                    <div id="botnav" class="col-md-6 hidden-sm-down">
                        <nav>
                            <?php wp_nav_menu(
                                array(
        ...
        <div id="bot-bot">
            <div class="container">
                <div class="row no-gutters justify-content-center justify-content-lg-start align-items-middle">
                    <div class="col-md-6 my-auto text-center text-md-right order-md-2">
                    ...
                    <div class="col-md-6 my-auto text-center text-md-left order-md-1">
